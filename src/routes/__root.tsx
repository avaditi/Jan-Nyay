...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Understand contracts, agreements, insurance and notices in plain language. Risk Radar, Fairness Score, What-If Simulator and a multilingual legal assistant." },
      { name: "author", content: "Jan-Nyay" },
      { property: "og:title", content: "Jan-Nyay — AI Legal Copilot" },
      { property: "og:description", content: "Plain-language legal understanding for every Indian citizen." },
